odoo.define("apco.DocumentsControllerMixin", function (require) {
    "use strict";

    console.log('test');

    const TemplateDialog = require("apco.TemplateDialog");
    const { ComponentWrapper } = require("web.OwlCompatibility");

    const NewDocumentControllerMixin = {
        events: {
            "click .o_documents_kanban_new_document": "_onNewDocument",
        },
        custom_events: {
        ...
        updateButtons() {
            ...
            this.$buttons[0].querySelector(
                ".o_documents_kanban_new_document"
         ...
         * @param {MouseEvent} ev
         */
         _onNewDocument: async function (ev) {
            ev.preventDefault();
            ev.stopPropagation();
    ...
    return NewDocumentControllerMixin;
});
